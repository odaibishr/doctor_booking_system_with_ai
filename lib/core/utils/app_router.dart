...
import 'package:doctor_booking_system_with_ai/features/forget_password/email_input/presention/email_input.dart';
...
class AppRouter {
  ...
  static const String verfiycodeViewRout = '/verfiycodeVeiw';
  static const String createnewpasswordViewRout='/createnewpasswordView';
  ...
  static GoRouter router = GoRouter(
    routes: [
      ...
      GoRoute(
        ...
        builder: (context, state) => const EmailInput(),
      ),
      GoRoute(
      ...
      GoRoute(
        path: createnewpasswordViewRout,
