...
class BottomSheetDeteals extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      SizedBox(height: 10,),
      Text('لقد تم حجز موعد مع',style: FontStyles.subTitle3.copyWith(color: AppColors.gray500),),
      SizedBox(height: 12,),
      ...
      Row(mainAxisAlignment:MainAxisAlignment.center,
        ...
        Text('عدي جلال محمد بشر',style: FontStyles.subTitle3.copyWith(color: AppColors.gray400),),
      ],),
      SizedBox(height: 22,),
      ...
      Container(padding: EdgeInsets.symmetric(horizontal: 20),
        child: MainButton(text: 'إظهار الحجز', onTap:(){
          GoRouter.of(context).pushReplacement(AppRouter.bookingHistoryViewRoute);
        })),
      SizedBox(height: 5),
        TextButton(child: Text('العودة للرئيسية',style:FontStyles.subTitle1,),onPressed: (){
